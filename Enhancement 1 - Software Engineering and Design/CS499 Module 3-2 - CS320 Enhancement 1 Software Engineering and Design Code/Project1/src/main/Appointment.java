...
public class Appointment {
	...
	public Appointment(String appointmentID, Date appointmentDate, String appointmentDescription) {
		...
		if(appointmentDate == null || appointmentDate.before(currentDate)) {//orignally the right side was currentDate.before(appointmentDate), however it was the other way around.
